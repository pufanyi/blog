...
async function main() {
  ...
  const output = `// Auto-generated by scripts/build-posts.mts — do not edit manually
...
`;
  ...
  const redirectsOutput = `// Auto-generated by scripts/build-posts.mts — do not edit manually
...
`;
  ...
  const cvOutput = `// Auto-generated by scripts/build-posts.mts — do not edit manually

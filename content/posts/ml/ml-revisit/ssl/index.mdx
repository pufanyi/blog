...
SwAV [@caron2020swav] 联合学习 encoder 与一组共享 prototypes。每个 view 先判断自己如何分配到这些 prototypes，再用这份 assignment 监督另一个 view。

<SwappedAssignments />

**交换的是 assignment，不是逐坐标匹配两个 projection。** Prototype 是可学习的向量，没有预先指定的「猫」「狗」类别含义。

<details>
<summary>Prototype scores 与 swapped prediction loss</summary>
